export const SITE_RULE_SET_BASE_URL =
  "https://gh.sageer.me/https://raw.githubusercontent.com/lyc8503/sing-box-rules/refs/heads/rule-set-geosite/";
export const IP_RULE_SET_BASE_URL =
  "https://gh.sageer.me/https://raw.githubusercontent.com/lyc8503/sing-box-rules/refs/heads/rule-set-geoip/";
// Custom rules
...
export const UNIFIED_RULES = [
  ...
  },
  {
    name: "AI Services",
    outbound: "💬 AI 服务",
    site_rules: ["openai", "anthropic", "jetbrains-ai", "perplexity", "cursor"],
    ip_rules: [],
  },
  {
    name: "Bilibili",
...
export function getOutbounds(selectedRuleNames) {
  ...
  return UNIFIED_RULES.filter((rule) => selectedRuleNames.includes(rule.name)).map((rule) => rule.outbound);
}
